...
void addToStack(Typer * env, Term * item);
...
Term * evaluate(MemoryArena * arena, Typer * env, Term ** args, Term * in0);
Term * evaluateAndNormalize(MemoryArena * arena, Typer * env, Term ** args, Term * in0);
