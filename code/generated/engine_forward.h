...
Term * evaluate(MemoryArena * arena, Stack * stack, OverwriteRules * rules, Term * in0, i32 offset);
Term * evaluateWithArgs(MemoryArena * arena, i32 arg_count, Term ** args, Term * in0);
CompareTerms compareTerms(MemoryArena * arena, Term * lhs0, Term * rhs0);
Trinary equalTrinary(Term * lhs0, Term * rhs0);
Term * normalize(MemoryArena * arena, OverwriteRules * rules, Term * in0);
