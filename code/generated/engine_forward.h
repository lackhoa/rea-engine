...
Term * evaluate(MemoryArena * arena, Stack * stack, Typer * env, Term * in0, i32 offset);
Term * evaluateWithArgs(MemoryArena * arena, Typer * env, i32 arg_count, Term ** args, Term * in0);
