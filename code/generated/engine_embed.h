#define embed_Arrow(name) union { Arrow name; struct { union {Ast a; struct {AstCategory cat; Token token; }; }; Ast * output_type; s32 param_count; Token * param_names; Ast ** param_types;  }; };
